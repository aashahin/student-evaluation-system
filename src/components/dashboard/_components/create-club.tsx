...
const CreateClubDialog = ({
  ...
  const validateForm = (): boolean => {
    ...
    if (!formData.grade_level) {
      errors.grade_level = "الحلقة الدراسية مطلوبة";
    }
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[425px] bg-white">
        <DialogHeader>
          ...
          <DialogDescription>قم بإدخال معلومات النادي الجديد</DialogDescription>
        </DialogHeader>
          ...
          <div className="grid gap-4 py-4">
            ...
            <div className="grid gap-2">
              ...
              >
                <SelectTrigger
                  className={
                    formState.errors.grade_level ? "border-red-500" : ""
                  }
                >
            ...
            <div className="grid gap-2">
              ...
              <Input
                ...
                min={3}
                placeholder="اتركه فارغا للحصول على الحد الأقصى (15)"
              />
            </div>
          </div>
          <DialogFooter>
